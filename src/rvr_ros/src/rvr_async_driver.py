...
class RobotDriver(DriverLogger):
    ...
    async def enable_sensors(self) -> None:
        ...
        await self.rvr.sensor_control.start(interval=self.SENSOR_STREAMING_INTERVAL)
